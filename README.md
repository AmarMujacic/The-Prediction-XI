...
|  **Venue strength** (last 10) | Avg goals scored/conceded at home vs away, win rate |
|  **Differentials** | Home minus away: form points, goal difference, win rate |
|  **Elo ratings** | Continuously updated team strength score |
|  **Season context** | Normalised matchday, league encoding |
...
>  In FM26, `Ctrl+P` opens *Preferences* — use the export icon on a league-table view for HTML, or just use the CSV method above.
...
-  Strict time-based split — test set is always 2015/16
